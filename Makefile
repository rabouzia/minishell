...
#    Updated: 2024/06/13 11:24:21 by junsan           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
PARSING	= process_input.c tokenize.c parsing.c prints.c arg_parse.c get_file_list.c	\
		prints_2.c																\
		/utils/parsing_utils.c /utils/tokenize_utils.c /utils/tokenize_utils_2.c	\
		/utils/get_file_list_utils.c /utils/type_redir_functions.c 					\
